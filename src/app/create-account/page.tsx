  ...
  return (
    <main className="flex min-h-screen items-center justify-center px-4 pb-24">
      <div className="bg-popover relative flex w-full max-w-sm flex-col items-center rounded-lg border p-8">
        ...
        {isPending && (
          <div
            className="text-primary absolute left-1/2 top-1/2 flex
          -translate-x-1/2 -translate-y-1/2 flex-col items-center gap-y-2"
          >
        ...
        <form
          className={`flex w-dull flex-col gap-4 ${
            isPending && "-z-10 opacity-0"
          }`}
